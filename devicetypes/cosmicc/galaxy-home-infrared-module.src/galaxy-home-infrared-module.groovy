/**
 *  Galaxy Home Infrared Module
 *
 *  Copyright 2017 cosmicc
 *
 ...
 */
metadata {
	definition (name: "Galaxy Home Infrared Module", namespace: "cosmicc", author: "cosmicc") {
		capability "Button"
		capability "Power"
		capability "Refresh"
...
def gimcmd() {
	log.debug "Executing 'gimcmd'"
	// TODO: handle 'gimcmd' command
}